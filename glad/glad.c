/*
    ...
    OpenGL loader generated by glad 0.1.16a0 on Thu Feb  8 10:04:38 2018.
    ...
    Commandline:
        --profile="core" --api="gl=4.3" --generator="c" --spec="gl" --no-loader --local-files --omit-khrplatform --extensions="GL_ARB_debug_output,GL_ATI_meminfo,GL_NVX_gpu_memory_info"
    Online:
        http://glad.dav1d.de/#profile=core&language=c&specification=gl&api=gl%3D4.3&extensions=GL_ARB_debug_output&extensions=GL_ATI_meminfo&extensions=GL_NVX_gpu_memory_info
*/
